...
export class Bird extends Component<Phaser.GameObjects.Image> {
    ...
    collideWith(object: ParallaxImage | Pipe) {
        ...
        // So we have to get the value of top left to calculate the AABB collision
        const x = this.x - Bird.WIDTH / 2;
        const y = this.y - Bird.HEIGHT / 2;
        ...
        const offsetX = x + topLeftOffset;
        const offsetY = y + topLeftOffset;
